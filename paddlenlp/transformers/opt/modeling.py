...
class MultiHeadAttention(nn.Layer):
    ...
    def forward(self, query, key, value, attn_mask=None, use_cache=False, cache=None, output_attention=None, use_flash_attn=use_flash_attn_env, is_causal=use_flash_attn_env):
        r"""
